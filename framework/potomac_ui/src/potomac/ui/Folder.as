...
package potomac.ui
{
	...
	[ExtensionPoint(id="Folder", idRequired="true", page="*string", folderType="string", location="*choice:top,bottom,left,right", relativeTo="*string", percent="*integer", open="boolean")]
