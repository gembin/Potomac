...
package potomac.ui
{
	...
	[ExtensionPoint(id="Template", declaredOn="classes", idRequired="true", preloadRequired="true", type="mx.core.UIComponent", properties="string")]
	...
	public class PotomacUI extends EventDispatcher
	{
		...
		public function closePage(page:Page, promptForSave:Boolean=true):void
		{
			...
			if (promptForSave && page.containsDirty())
			{
				...
				_pageVars[page].saveAlert=Alert.show("'" + page.descriptor.title + "' has been modified.  Save changes?", "Save", Alert.YES | Alert.NO | Alert.CANCEL, null, onCloseSavePrompt, null, Alert.YES);
				return;
			}
